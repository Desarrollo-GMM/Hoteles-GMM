...
export function Listbox<T>({
  ...
  autoFocus?: boolean;
  "aria-label"?: string;
  personalizedIcon?: React.ReactElement;
  onClick?: ()=>void;
    ...
    <Headless.Listbox {...props} multiple={false}>
      <Headless.ListboxButton
        ...
        className={clsx([
          ...
          "focus:outline-none",
          // Focus ring
          "after:pointer-events-none after:absolute after:inset-0 after:rounded-lg after:ring-inset after:ring-transparent after:data-[focus]:ring-2 after:data-[focus]:ring-principal-500",
          // Disabled state
        ...
        return (
          <div
            className={clsx(
              ...
              // Focus
              "outline-none data-[focus]:bg-principal-600 data-[focus]:text-gray-500",
              // Forced colors mode
