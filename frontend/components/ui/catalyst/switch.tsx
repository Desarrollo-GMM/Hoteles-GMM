...
const colors = {
  ...
  principal: [
    '[--switch-bg-ring:theme(colors.principal.700/90%)] [--switch-bg:theme(colors.principal.600)] dark:[--switch-bg-ring:theme(colors.principal/15%)]',
    '[--switch-ring:theme(colors.principal.700/90%)] [--switch:white]',
  ],
  zinc: [
  ...
  return (
    <Headless.Switch
      ...
      className={clsx(
        ...
        // Unchecked
        'bg-rose-800 ring-1 ring-inset ring-black/5 dark:bg-red-500 dark:ring-white/15',
        // Checked
