    ...
    return (
        <div className="mt-10">
            ...
            <div className="w-full flex items-center justify-center gap-5">
                ...
                <div data-aos="fade-up" className="w-full max-w-sm pl-0 p-6 bg-neutral-primary-soft rounded-2xl shadow-xs bg-gradient-to-tr from-green-100 to-green-300">
                    <h5 className="mb-4 text-2xl font-bold font-roboto text-body text-center text-black">Accesibilidad</h5>
                    <ul role="list" className="space-y-2 my-6 pl-6 bg-white rounded-r-2xl py-4 px-2 border-l-0 border-8 border-green-200">
                        <AutoScrollComponent
                            speed="medium"
                ...
                <div data-aos="fade-down" className="w-full max-w-sm pl-0 p-6 bg-neutral-primary-soft rounded-2xl shadow-xs bg-gradient-to-tr from-green-200 to-green-400">
                    <h5 className="mb-4 text-2xl font-roboto font-bold text-body text-center text-black bg-">Accesibilidad</h5>
                    <ul role="list" className="space-y-2 my-6 pl-6 bg-white rounded-r-2xl py-4 px-2 border-l-0 border-8 border-green-300">
                        <AutoScrollComponent
                            speed="slow"
                            direction="horizontal"
                            reverse={false}
                ...
                <div data-aos="fade-up" className="w-full max-w-sm pl-0 p-6 bg-neutral-primary-soft rounded-2xl shadow-xs bg-gradient-to-tr from-green-300 to-green-500">
                    <h5 className="mb-4 text-2xl font-bold font-roboto text-body text-center text-black">Accesibilidad</h5>
                    <ul role="list" className="space-y-2 my-6 pl-6 bg-white rounded-r-2xl py-4 px-2 border-l-0 border-8 border-green-400">
                        <AutoScrollComponent
                            speed="medium"
                            direction="horizontal"
                            reverse={false}
