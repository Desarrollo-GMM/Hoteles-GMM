...
const PromotionComponent: React.FC<ComponentProps> = () => {
    return (
        <div className="grid md:grid-cols-2 gap-6 px-4 mt-24 md:px-8 lg:px-20 py-12">
            <a href="#" className="flex flex-col mx-auto items-center border border-3 hover:bg-white border-gray-300 rounded-xl shadow-xs md:flex-row md:max-w-5xl hover:scale-105 hover:shadow-xl transition duration-200">
                <Image 
                    className="object-cover w-full rounded-xl h-full mb-4 md:mb-0" 
            ...
            <a href="#" className="flex flex-col mx-auto items-center border border-3 hover:bg-white border-gray-300 rounded-xl shadow-xs md:flex-row md:max-w-5xl hover:scale-105 hover:shadow-xl transition duration-200">
                ...
                <div className="flex flex-col justify-between md:p-4 leading-normal">
                    ...
                    <div className="flex justify-between align-middle">
                        <p className="font-bold text-xs my-auto">Call center: 55 4440 0662</p>
