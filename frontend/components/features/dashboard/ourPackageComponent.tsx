    ...
    return (
        <div className="px-4 md:px-8 lg:px-20 lg:py-12 py-5">
            ...
            <div className="grid lg:grid-cols-2 gap-8 mb-12">
                ...
                <div className="flex tems-start lg:items-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-10 lg:px-20 auto-rows-fr">
                {images.map((src, index) => (
                    <div key={index} className="group relative overflow-hidden rounded-xl shadow-lg hover:shadow-black transition-all duration-300 transform hover:-translate-y-1">
                        <div className="relative h-96 lg-64">
                            <Image
                                className="object-cover w-full lg:h-full group-hover:scale-105 transition-transform duration-500"
                                src={src}
