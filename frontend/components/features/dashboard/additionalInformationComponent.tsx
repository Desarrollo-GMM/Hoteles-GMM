...
const AdditionalInformationComponent: React.FC<ComponentProps> = ({
    ...
    return (
        <div className="px-1 md:px-8 lg:px-20 py-1 lg:py-12">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 m-3 lg:m-0 border border-gray-300 rounded-xl lg:border-none">
                <div className="flex md:justify-center lg:justify-end" data-aos="fade-up">
                ...
                <div className="flex flex-col items-center justify-center m-3 lg:m-0" data-aos="fade-up">
                    ...
                    <button type="button"
                        className="text-danger mx-auto border-1 border-black text-black rounded-full bg-neutral-primary border border-danger hover:bg-black hover:text-white focus:ring-4 focus:ring-neutral-tertiary font-medium leading-5 rounded-base text-sm px-4 py-2.5 focus:outline-none transition-all duration-300 ease-in-out">
