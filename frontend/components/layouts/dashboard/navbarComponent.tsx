                ...
                <div className="flex items-center justify-between h-full">
                    ...
                    <div className="hidden md:flex items-center space-x-5">
                        ...
                        <a href="https://www.facebook.com/HotelesGrupoMundoMaya" target="_blank" className="text-body hover:text-heading transform hover:scale-110 transition duration-300">
                            <svg className="w-6 h-6 text-slate-300 hover:text-blue-600" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="https://x.com/HGrupomundomaya" target="_blank" className="text-body hover:text-heading transform hover:scale-110 transition duration-300">
                            <svg className="w-6 h-6 text-slate-300 hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="https://www.instagram.com/hotelesgrupomundomaya/" target="_blank" className="text-body hover:text-heading transform hover:scale-110 transition duration-300">
                            <svg className="w-7 h-7 text-slate-300 hover:text-pink-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
